...
public class TimelineRepository {
    ...
    final static private RowMapper<Timeline> ROW_MAPPER = (ResultSet resultSet, int rowNum )
            -> Timeline.builder()
    ...
    throw new UnsupportedOperationException("Timeline은 생신을 지원하지 않습니다.");
    ...
    public List<Timeline> finallAllByMemberIdOrderByIdDesc(Long memberId, int size){
        var sql = String.format("""
                Select *
                From %s
